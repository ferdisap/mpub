...
/**
 * // TCPDF_FONTS::addTTFfont("./pdf2/font/tahoma.ttf",'','',32); // akan me write file di tecnickcom/tcpdf/fonts/...
 * // TCPDF_FONTS::addTTFfont("./pdf2/font/tahomab.ttf",'','',32); // akan me write file di tecnickcom/tcpdf/fonts/...
 * // TCPDF_FONTS::addTTFfont("./pdf2/font/tahomai.ttf",'','',32); // akan me write file di tecnickcom/tcpdf/fonts/...
 * // TCPDF_FONTS::addTTFfont("./pdf2/font/tahomabi.ttf",'','',32); // akan me write file di tecnickcom/tcpdf/fonts/...
 */
class PMC_PDF extends TCPDF
{
  ...
  public static function registerFont($fontname = 'tahoma')
  {
    TCPDF_FONTS::addTTFfont("./pdf2/font/{$fontname}.ttf", '', '', 32); // akan me write file di tecnickcom/tcpdf/fonts/...
    TCPDF_FONTS::addTTFfont("./pdf2/font/{$fontname}b.ttf", '', '', 32); // akan me write file di tecnickcom/tcpdf/fonts/...
    TCPDF_FONTS::addTTFfont("./pdf2/font/{$fontname}i.ttf", '', '', 32); // akan me write file di tecnickcom/tcpdf/fonts/...
    TCPDF_FONTS::addTTFfont("./pdf2/font/{$fontname}bi.ttf", '', '', 32); // akan me write file di tecnickcom/tcpdf/fonts/...
  }
